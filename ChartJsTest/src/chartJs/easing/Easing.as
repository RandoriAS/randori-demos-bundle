...
public class Easing {
    ...
    public static const EASE_INSIN_E:String = "easeInSine";
    public static const EASE_OUT_SIN_E:String = "easeOutSine";
    public static const EASE_IN_OUT_SIN_E:String = "easeInOutSine";
