...
public class LabsService extends AbstractService {
		...
		public function LabsService(xmlHttpRequest:XMLHttpRequest, config:ServiceConfig, targets:GenericJsonParser ) {
